...
原子化 CSS 是一种 CSS 的架构方式，它倾向于小巧且用途单一的 class，并且会以视觉效果进行命名。有些人可能会称其为函数式 CSS，或者 CSS。市面上有不少的gong工具框架，如Tailwind CSS、Windi CSS
...
[click]Generator 函数,S6 引入的特殊函数，用于生成迭代器对象。可以通过 yield 暂停和恢复执行。常用于异步操作和控制流管理
